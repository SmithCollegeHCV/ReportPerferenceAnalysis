...
- Q4 (how often do the reports contain charts/grphs) ranks among the top five most accurate (#4 in bagged model and #3 in random forsets) and pure(#4 in bagged model and #3 in randomforests) predictors in in determining what makes a report useful 
