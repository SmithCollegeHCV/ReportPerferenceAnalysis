...
```
Q12 most ideal layout for strategic decisions trategic layout for  ranks high in both accuarcy and purity (1 accuracy and 3rd purity). 
q14 same but for operational decisions.


q4 how often do the reports contain charts/grphs
...
```
Q14 and q5: do you interact with reports by makes notes or highlighting. q10 is consitent across q7
# Random Forests Q16
```{r}
...
```
Q16: process to maing decision Q5 and q11 tactical. changes in q 11
# Random Forests Q18
```{r}
...
q12 is important across multiple runs

q12 and q15 are showing